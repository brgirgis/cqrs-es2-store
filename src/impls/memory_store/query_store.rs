...
/// Sync memory query store useful for testing purposes only
    ...
    > QueryStore<C, E, A, Q>
{
    ...
    pub fn new(queries: Arc<LockedQueryContextMap<C, E, Q>>) -> Self {
        ...
        trace!(
            "Created new sync memory query store from passed Arcs"
        );
    ...
    > Default for QueryStore<C, E, A, Q>
{
    fn default() -> Self {
        ...
        trace!("Created default sync memory query store");
